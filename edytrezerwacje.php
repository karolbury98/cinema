...
<div class="collapse navbar-collapse" id="collapse_target">
 ...
 <tbody>
<?php
$sql="SELECT * FROM reservations ORDER BY id_reservation";
$res=$con->query($sql); 
...
{ 
  ...
  print '<tr><td>'.$row['id_reservation'].'</td>'; 
  print '<td><a href="usunrez.php?id_reservation='.$row['id_reservation'].'">X</a></td>';
  print '<td>'.$row['id_movie'].'</td>'; 
  print '<td>'.$row['row'].'</td>'; 
