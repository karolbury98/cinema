...
<span class="navbar-toggler-icon"></span>
  ...
  <div class="main bg-secondary text-white">
    <div class="container">
      <div class="row">
      <div class="col-sm-12">
      <h4>Nadchodzące premiery</h4>
    </div>
    <?php
                $sql = "SELECT * FROM trailers ORDER BY premiere_date;";
                ...
                if ($resultCheck > 0) {
                    while ($row = mysqli_fetch_assoc($result)){
                       ...
                       print '<div class="opis"><p>'.$row['description'].'</br></br>Czas trwania: '.$row['length'].'</br></br> Premiera: '.$row['premiere_date'].'</br></br></p></div>';
                    }
                    print '</div>';
                    print '</section>';
                }
